...
namespace InfinityCode.UltimateEditorEnhancer.SceneTools
{
    ...
    public static class Waila
    {
        ...
        public static SceneViewItem GetSceneViewItem(SceneView view)
        {
            ...
            SceneViewItem r;
            return sceneViewItems.TryGetValue(Compatibility.GetInstanceID(view), out r) ? r : null;
        }
        ...
        private static void OnSceneGUI(SceneView view)
        {
            ...
            sceneViewItems.TryGetValue(Compatibility.GetInstanceID(view), out sceneViewItem);
            ...
            if (sceneViewItem == null)
            {
                ...
                sceneViewItems.Add(Compatibility.GetInstanceID(view), sceneViewItem);
            }
