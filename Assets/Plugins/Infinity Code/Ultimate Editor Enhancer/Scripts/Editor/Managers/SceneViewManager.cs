...
namespace InfinityCode.UltimateEditorEnhancer
{
    ...
    public static class SceneViewManager
    {
        ...
        private static EventModifiers pressModifiers;
        ...
        public static Rect GetRect(SceneView view)
        {
            ...
            int id = Compatibility.GetInstanceID(view);
            VisualElement el;
        ...
        private static void OnMouseDown(Event e)
        {
            ...
            pressModifiers = NormalizeModifiers(e.modifiers);
            waitOpenMenu = true;
        ...
        private static void OnMouseDrag(Event e)
        {
            ...
            if ((e.mousePosition - pressPoint).sqrMagnitude > 100)
            {
                waitOpenMenu = false;
            }
        }
        ...
        private static void OnMouseUp(Event e)
        {
            ...
            waitOpenMenu = false;
            EventModifiers modifiers = pressModifiers;
            ...
            if (Prefs.pickGameObject && modifiers == Prefs.pickGameObjectModifiers)
            {
                Selection.activeGameObject = HandleUtility.PickGameObject(e.mousePosition, false);
            }

            if (ShouldOpenContextMenu(modifiers))
            {
#if !UNITY_2021_1
        ...
        private static EventModifiers NormalizeModifiers(EventModifiers modifiers)
        {
            return modifiers & (EventModifiers.Alt | EventModifiers.Command | EventModifiers.Control | EventModifiers.FunctionKey | EventModifiers.Shift);
        }

        private static bool ShouldOpenContextMenu(EventModifiers modifiers)
        {
            return Prefs.contextMenuOnRightClick && (modifiers == Prefs.rightClickModifiers || modifiers == Prefs.pickGameObjectModifiers);
        }
