...
namespace InfinityCode.UltimateEditorEnhancer.Windows
{
    ...
    public class ComponentWindow : AutoSizePopupWindow
    {
        ...
        private void DrawHeaderPreview(Rect r)
        {
            ...
            bool isLoadingAssetPreview = EditorCompatibility.IsLoadingAssetPreview(Compatibility.GetInstanceID(component));
        ...
        public void InitEditor()
        {
            ...
            if (component is Terrain)
            {
                ...
                if (editor == null)
                {
                    ...
                    TerrainInspectorRef.SetActiveTerrainInspector(Compatibility.GetInstanceID(editor));
                }
            }
            else
            {
