    ...
    public static class BestIconDrawer
    {
        ...
        private static void DrawItem(HierarchyItem item)
        {
            ...
            if (e.type == EventType.Layout)
            {
                ...
                int wid = Compatibility.GetInstanceID(lastHierarchyWindow);
        ...
        private static void Init()
        {
            ...
            {
                int wid = Compatibility.GetInstanceID(window);
        ...
        private static void OnGUIBefore(int wid)
        {
            ...
            EditorWindow w = EditorCompatibility.EntityIdToObject(wid) as EditorWindow;
