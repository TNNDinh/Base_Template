...
namespace InfinityCode.UltimateEditorEnhancer.Behaviors
{
    ...
    public static class SelectionHistory
    {
        ...
        static SelectionHistory()
        {
            ...
            int[] instanceIds = EditorCompatibility.GetSelectionInstanceIds();
            if (instanceIds.Length > 0) Add(instanceIds);
        }
        ...
        public static void Add(params int[] ids)
        {
            ...
            {
                Object obj = EditorCompatibility.EntityIdToObject(id);
        ...
        public static void Next()
        {
            ...
            EditorCompatibility.SetSelectionInstanceIds(_records[index].ids);
            Event.current.Use();
        }
        ...
        private static void SelectionChanged()
        {
            ...
            {
                Add(EditorCompatibility.GetSelectionInstanceIds());
            }
        }
