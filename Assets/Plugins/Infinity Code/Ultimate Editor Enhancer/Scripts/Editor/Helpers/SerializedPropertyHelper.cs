...
namespace InfinityCode.UltimateEditorEnhancer
{
    public static class SerializedPropertyHelper
    {
        ...
        public static void FromJson(SerializedProperty prop, Json json)
        {
            switch (prop.propertyType)
            {
                case SerializedPropertyType.Generic:
                ...
                case SerializedPropertyType.Color:
                    ...
                    break;
                case SerializedPropertyType.ObjectReference:
                    prop.objectReferenceValue = json.Value<int>() != 0 ? EditorCompatibility.EntityIdToObject(json.Value<int>()) : null;
                    break;
                case SerializedPropertyType.LayerMask:
                    prop.intValue = json.Value<int>();
                    break;
                ...
                case SerializedPropertyType.Quaternion:
                    ...
                    break;
                case SerializedPropertyType.ExposedReference:
                    prop.exposedReferenceValue = json.Value<int>() != 0 ? EditorCompatibility.EntityIdToObject(json.Value<int>()) : null;
                    break;
                case SerializedPropertyType.Vector2Int:
        ...
        public static Json ToJson(SerializedProperty prop)
        {
            switch (prop.propertyType)
            {
                case SerializedPropertyType.Generic:
                ...
                case SerializedPropertyType.ObjectReference:
                    if (!prop.objectReferenceValue) return new JsonValue(null);
                    return new JsonValue(Compatibility.GetInstanceID(prop.objectReferenceValue));
                case SerializedPropertyType.LayerMask:
                    return new JsonValue(prop.intValue);
                case SerializedPropertyType.Vector2:
                ...
                case SerializedPropertyType.ExposedReference:
                    if (!prop.exposedReferenceValue) return new JsonValue(null);
                    return new JsonValue(Compatibility.GetInstanceID(prop.exposedReferenceValue));
                case SerializedPropertyType.Vector2Int:
