...
namespace UnityScreenNavigator.Runtime.Core.Shared
{
    ...
    {
        Linear,
        [InspectorName("InQuad")] QuadraticEaseIn,
        [InspectorName("OutQuad")] QuadraticEaseOut,
        [InspectorName("InOutQuad")] QuadraticEaseInOut,
        [InspectorName("InCubic")] CubicEaseIn,
        [InspectorName("OutCubic")] CubicEaseOut,
        [InspectorName("InOutCubic")] CubicEaseInOut,
        [InspectorName("InQuart")] QuarticEaseIn,
        [InspectorName("OutQuart")] QuarticEaseOut,
        [InspectorName("InOutQuart")] QuarticEaseInOut,
        [InspectorName("InQuint")] QuinticEaseIn,
        [InspectorName("OutQuint")] QuinticEaseOut,
        [InspectorName("InOutQuint")] QuinticEaseInOut,
        [InspectorName("InSine")] SineEaseIn,
        [InspectorName("OutSine")] SineEaseOut,
        [InspectorName("InOutSine")] SineEaseInOut,
        [InspectorName("InCirc")] CircularEaseIn,
        [InspectorName("OutCirc")] CircularEaseOut,
        [InspectorName("InOutCirc")] CircularEaseInOut,
        [InspectorName("InExpo")] ExponentialEaseIn,
        [InspectorName("OutExpo")] ExponentialEaseOut,
        [InspectorName("InOutExpo")] ExponentialEaseInOut,
        [InspectorName("InElastic")] ElasticEaseIn,
        [InspectorName("OutElastic")] ElasticEaseOut,
        [InspectorName("InOutElastic")] ElasticEaseInOut,
        [InspectorName("InBack")] BackEaseIn,
        [InspectorName("OutBack")] BackEaseOut,
        [InspectorName("InOutBack")] BackEaseInOut,
        [InspectorName("InBounce")] BounceEaseIn,
        [InspectorName("OutBounce")] BounceEaseOut,
        [InspectorName("InOutBounce")] BounceEaseInOut
    }
